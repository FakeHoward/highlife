...
const Map<String, Map<AppLocale, String>> _messages = {
  ...
  'loginTagline': {
    AppLocale.en:
        'Your Matrix conversations, refined for desktop and mobile.',
    AppLocale.ru: 'Ваши Matrix-беседы — удобно на компьютере и телефоне.',
  },
  ...
  'registerHint': {
    AppLocale.en: 'Pick a username on this homeserver. No email required.',
    AppLocale.ru: 'Выберите имя на этом сервере. Email не нужен.',
  },
  ...
  'loginSessionNote': {
    AppLocale.en:
        'Session credentials stay on this device. Use the same homeserver account on web and mobile.',
    AppLocale.ru:
        'Данные сессии хранятся на этом устройстве. Тот же аккаунт homeserver работает в web и на мобильном.',
  },
  'continueWithSso': {
  ...
  'noConversations': {
    AppLocale.en: 'Join a room or create a private encrypted space to start chatting.',
    AppLocale.ru:
        'Вступите в комнату или создайте приватное зашифрованное пространство.',
  },
  ...
  'selectConversationHint': {
    AppLocale.en:
        'Messages, files and bot actions stay in sync across devices.',
    AppLocale.ru:
        'Сообщения, файлы и действия ботов синхронизируются между устройствами.',
  },
