...
const en = {
  ...
  "composer.thread": "In thread",
  "composer.location": "Location",
  "composer.stickers": "Stickers",
  "composer.commands": "Commands",
  "composer.noStickers": "No sticker packs on this account yet.",
  "composer.locationDenied": "Could not read location. Enter latitude,longitude.",
  "composer.locationHint": "Latitude, longitude",
  ...
  "settings.signOutDevice": "End session",
  "settings.signOutDeviceHint": "Ends that session. Your account password may be required.",
  "settings.passwordToConfirm": "Password",
  ...
  "rooms.knock": "Ask to join",
  "rooms.knockSent": "Ask-to-join sent. Wait for a room admin.",
  "rooms.approveKnock": "Approve",
  "rooms.denyKnock": "Deny",
  "rooms.pendingKnocks": "Join requests",
  "rooms.noKnocks": "No pending join requests.",
  "rooms.membersCount": "{count} members",
...
const ru: Record<MessageKey, string> = {
  ...
  "composer.thread": "В треде",
  "composer.location": "Геопозиция",
  "composer.stickers": "Стикеры",
  "composer.commands": "Команды",
  "composer.noStickers": "На этом аккаунте пока нет наборов стикеров.",
  "composer.locationDenied": "Не удалось взять геопозицию. Введите широту,долготу.",
  "composer.locationHint": "Широта, долгота",
  ...
  "settings.signOutDevice": "Завершить сессию",
  "settings.signOutDeviceHint": "Завершает сессию на том устройстве. Может понадобиться пароль аккаунта.",
  "settings.passwordToConfirm": "Пароль",
  ...
  "rooms.knock": "Попросить доступ",
  "rooms.knockSent": "Заявка отправлена. Ждите администратора комнаты.",
  "rooms.approveKnock": "Принять",
  "rooms.denyKnock": "Отклонить",
  "rooms.pendingKnocks": "Заявки на вход",
  "rooms.noKnocks": "Нет заявок на вход.",
  "rooms.membersCount": "Участников: {count}",
